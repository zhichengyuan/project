...
@import "@/assets/css/use/pc.scss";
@import "@/assets/css/use/pro.scss";
@import "@/assets/css/use/ipad.scss";
@import "@/assets/css/use/phone.scss";
@import "@/assets/css/use/mini.scss";
</style>